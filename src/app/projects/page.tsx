...
import { buildWorkflowNote, highlightProjects } from "@/content/projects";
...
export const metadata: Metadata = buildPageMetadata({
  title: "Projects",
  description:
    "Projects by Dhruv Solanki with live demos, case studies, and GitHub — Quantis Global, HG Smelters, OpenSourceDisplayLink, and more.",
  path: "/projects",
});
    ...
    <SiteShell>
      <section className="py-2 md:py-6">
        ...
        <p className="body-soft mt-6 max-w-4xl text-lg">
          Each project leads with a <strong className="font-medium text-[#132232]">live link</strong> when
          available, then a case study, then{" "}
