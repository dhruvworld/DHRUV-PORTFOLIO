...
export default function QuantisGlobalPage() {
  return (
    <SiteShell>
      <section className="rounded-3xl border border-slate-200 bg-white p-10 text-slate-900 shadow-sm">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/contact" className="rounded-full bg-slate-900 px-5 py-3 text-sm font-medium text-white">
            Explore Services
          </Link>
          <Link href="/collaborations" className="rounded-full border border-slate-200 px-5 py-3 text-sm font-medium">
            Discuss Partnership
          </Link>
        </div>
      </section>

      <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-10 text-slate-900 shadow-sm">
      ...
      <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-10 text-slate-900 shadow-sm">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/business" className="rounded-full border border-slate-200 px-4 py-2 text-sm">
            Business
          </Link>
          <Link href="/case-studies" className="rounded-full border border-slate-200 px-4 py-2 text-sm">
            Case Studies
          </Link>
          <Link href="/contact" className="rounded-full border border-slate-200 px-4 py-2 text-sm">
            Contact
          </Link>
        </div>
      </section>
