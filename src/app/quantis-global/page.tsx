...
export default function QuantisGlobalPage() {
  return (
    <SiteShell>
      <section className="rounded-3xl border border-brand-navy/20 bg-brand-navy p-10 text-white shadow-sm">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/contact" className="rounded-full bg-white px-5 py-3 text-sm font-medium text-brand-navy">
            Explore Services
          </Link>
          <Link href="/collaborations" className="rounded-full border border-white/30 px-5 py-3 text-sm font-medium">
            Discuss Partnership
          </Link>
        </div>
      </section>

      <section className="mt-8 rounded-3xl border border-black/5 bg-white p-10 shadow-sm">
        <h2 className="text-3xl font-semibold tracking-tight">Service Pillars</h2>
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          {servicePillars.map((item) => (
            <article key={item} className="rounded-2xl border border-black/5 p-5">
      ...
      <section className="mt-8 rounded-3xl border border-black/5 bg-white p-10 shadow-sm">
        ...
        <div className="mt-6 space-y-3">
          {workflow.map((step) => (
            <p key={step} className="rounded-xl border border-black/5 p-4 text-muted">
              {step}
            </p>
          ))}
        </div>
      ...
      <section className="mt-8 rounded-3xl border border-black/5 bg-white p-10 shadow-sm">
        <h2 className="text-3xl font-semibold tracking-tight">Founder Connection</h2>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/business" className="rounded-full border border-black/10 px-4 py-2 text-sm">
            Business
          </Link>
          <Link href="/case-studies" className="rounded-full border border-black/10 px-4 py-2 text-sm">
            Case Studies
          </Link>
