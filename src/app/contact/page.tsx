...
export default function ContactPage() {
  return (
    <SiteShell>
      ...
      <section className="mt-8 rounded-2xl border border-black/10 bg-white/60 p-7">
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div className="flex flex-wrap content-start gap-3">
            <Link href="https://www.linkedin.com/in/dhruvworld/" className="cta-pill rounded-full border border-black/15 px-4 py-2 text-sm text-[#111]">
              LinkedIn
            </Link>
            <Link href="https://github.com/dhruvworld" className="cta-pill rounded-full border border-black/15 px-4 py-2 text-sm text-[#111]">
              GitHub
            </Link>
            <Link href="https://www.facebook.com/dhruv.solanki.4701" className="cta-pill rounded-full border border-black/15 px-4 py-2 text-sm text-[#111]">
              Facebook
            </Link>
          </div>
        </div>
