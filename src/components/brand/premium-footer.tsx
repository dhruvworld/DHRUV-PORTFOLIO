  ...
  return (
    <footer className="border-t border-black/10">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-10 md:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          <p className="text-sm font-medium text-[#132232]">Dhruv Solanki · Dhruv World</p>
          <p className="mt-3 max-w-sm text-xs leading-relaxed text-[#7a7a7a]">
            Founder of Quantis Global. Software, AI workflows, and international trade — Manchester, NH.
          </p>
