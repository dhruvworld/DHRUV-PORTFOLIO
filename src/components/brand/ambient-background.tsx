...
export function AmbientBackground() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      {reduceMotion ? (
        <>
          <div className="absolute -left-28 top-20 h-80 w-80 rounded-full bg-[#c9a66b]/20 blur-[110px]" />
          <div className="absolute -right-16 bottom-24 h-96 w-96 rounded-full bg-[#2e5e4e]/18 blur-[120px]" />
        </>
      ) : (
        <>
          <motion.div
