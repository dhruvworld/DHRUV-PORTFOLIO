const testimonials = [
  {
    quote:
      "Dhruv brings rare clarity between product thinking and execution. Systems feel refined, practical, and built to last.",
    name: "Collaborator",
    role: "Product Partner",
  },
  {
    quote:
      "The brand architecture work helped us communicate with more confidence across channels and close partnerships faster.",
    name: "Founder",
    role: "Startup Operator",
  },
  {
    quote:
      "Strong mix of AI workflow design and business realism. Every iteration moved us closer to measurable outcomes.",
    name: "Operator",
    role: "Growth Lead",
  },
];
    ...
    <section className="mt-28">
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-3">
        {testimonials.map((item) => (
          <article key={item.name} className="rounded-[1.35rem] border hairline bg-white/70 p-6">
